...
const TestmonialCard = ({src, alt, name, job, text}) => {
  return (
    <div className='w-full mx-auto md:w-[310px] md:h-[340px] lg:w-[310px] lg:h-[340px] xl:w-[310px] xl:h-[340px] bg-[#434343] p-5 flex flex-col  gap-10 rounded-3xl text-lightText relative z-10'>
