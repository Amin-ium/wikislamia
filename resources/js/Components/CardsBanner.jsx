...
import darkLogoFrench from "../../../public/assets/publicImages/darkLogoFrench.svg"
            ...
            <div className='w-full flex flex-row  xl:w-[80%]  lg:w-[80%] lg:mx-auto   mt-[50px] '>
                <div className='w-1/2 flex xl:flex-col '>
                    ...
                    <img src={check === 'eng' && darkMode ? lightLogoEnglish :
                        ...
                        check === 'ar' && !darkMode ? darkLogoArabic : null} alt="" className={`${check === 'ar' ? '' : ''} w-[100%] h-[100%] xl:w-[400px] xl:h-[200px] md:w-[300px] md:h-[200px] lg:w-[300px] lg:h-[200px]   mx-auto`} />

                    </div>

                </div>
                <div className='w-1/2  '>
                    <img src={cards} className=' w-[100%] h-[100%] xl:w-[400px] xl:h-[200px] md:w-[300px] md:h-[200px] lg:w-[300px] lg:h-[200px]  mx-auto' alt="" />
                </div>

            </div>
            <div className='w-[100%] lg:w-[70%] xl:w-[70%] mx-auto flex flex-col xl:mt-5'>

                    <p className={`${check === 'ar' ? 'text-center xl:text-right lg:text-right text-[22px] lg:text-[25px] xl:text-[25px]' : 'text-center text-[22px] lg:text-[2xl] xl:text-2xl'} ${darkMode ? 'text-lightText' : 'text-darkText'}  `}>
