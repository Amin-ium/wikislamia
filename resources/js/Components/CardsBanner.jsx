        ...
        <div className=' flex flex-col w-[90%] mx-auto mt-[50px]'>
            <div className='w-full flex flex-row justify-between xl:w-[90%] xl:mx-auto lg:w-[80%] lg:mx-auto'>
                <div className='w-1/2 flex flex-col lg:justify-center xl:justify-center mx-auto '>
                    <img src={darkMode ? logoLight : logoDark} alt="" className={`${check === 'ar' ? '' : ''} w-[90%] h-[90%]   md:w-[50%] md:h-[50%]  lg:w-[70%] lg:h-[70%] lg:ms-[50px] `} />
                    <h3 className={`${darkMode ? 'text-lightText' : 'text-darkText'} text-xs md:text-xl -mt-[35px] ms-[80px] w-full lg:ms-[190px] lg:-mt-[60px] xl:-mt-[50px] xl:ms-[250px]`}>
            ...
            <div className='w-[100%] lg:w-[70%] mx-auto flex flex-col'>
                    ...
                    <p className={`${check === 'ar' ? 'text-center xl:text-right lg:text-right text-[16px] lg:text-[25px]' : 'text-center text-[16px] lg:text-[2xl]'} ${darkMode ? 'text-lightText' : 'text-darkText'} text-xl `}>
                    ...
                    <h4 className={`lg:w-[300px] ${darkMode ? 'text-lightText' : 'text-darkText'} text-[10px] text-center`}>{
