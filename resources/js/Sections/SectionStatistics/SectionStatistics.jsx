...
const SectionStatistics = () => {
  ...
  return (
    <section ref={sectionRefs.section5} className={`${ darkMode ? "border-b-[1px] border-[#f1f1f125] " : "border-b-[1px] border-[#28282825]"} w-[100%] mt-[100px] xl:mt-0 relative py-[50px]`}>
        ...
        <img src={lampe} alt="" className='absolute w-[200px] h-[200px] -top-[40px] left-0 z-30' />
        <img src={quran} alt="" className='absolute w-[200px] h-[200px]  -top-[120px] xl:top-[340px] right-0 z-30'  />
